...
SELECT 
   ...
   CAST(SUBSTRING('2022-01-29T09:33:53.444+05:30', 12, 8) AS TIME) as time_auto, 
    ...
    {{ dbt_utils.star(from = ref('nonregular_use_tracking_normalized'), except=['being_who_who', '_version_', '_submission_time', 'begin_group_aypvm5n7n_child_boy_number', 'begin_group_nrhrybak5_child_boy_number', 'begin_group_b0spfk4xt_child_boy_number', 'begin_group_aypvm5n7n_passerby_man_number', 'begin_group_b0spfk4xt_passerby_man_number', 'begin_group_b0spfk4xt_child_girl_number', 'begin_group_b0spfk4xt_passerby_woman_number', 'begin_group_aypvm5n7n_passerby_women_number', 'begin_group_aypvm5n7n_child_girl_number', 'begin_group_lky5gqsbu_child_girl_number', '_airbyte_ab_id', '_xform_id_string', '_id', 'starttime', 'endtime', '_validation_status', 'formhub_uuid', 'meta_instancename', '_uuid', '_tags', '_geolocation', '_version', '_status', 'meta_instanceid', '_attachments', '_submitted_by', '_notes', '__version__', ])}}
