...
SELECT
    ...
    unnest(ARRAY[
        electrical_group_outage_bulb_full, 
    ...
    unnest(ARRAY[
        electrical_group_outage_bulb_hours, 
    ...
    unnest(ARRAY[
        electrical_group_outage_bulb_fullfacility, 
